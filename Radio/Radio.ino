...
void loop() {
  ...
  switch (c)
  {
    case '1':
    {
        radio.setBandFrequency(FIX_BAND, 9000);
        break;
    }
    case '2':
    {
        radio.setBandFrequency(FIX_BAND, 9600);
        break;
    }
    case '3':
    {
        radio.setBandFrequency(FIX_BAND, 9650);
        break;
    }
    case '4':
    {
        radio.setBandFrequency(FIX_BAND, 10000);
        break;
    }
    case '5':
    {
        radio.setBandFrequency(FIX_BAND, 10200);
        break;
    }
  }
